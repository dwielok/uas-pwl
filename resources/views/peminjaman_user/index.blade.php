...
@section('content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Peminjaman Management</h2>
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                {{-- <a class="btn btn-icon icon-left btn-primary"
                                    href="{{ route('peminjaman.create') }}">Create New
                                    Peminjaman</a> --}}
                        ...
                        <div class="card-body">
                            <div class="show-import" style="display: none">
                                <div class="custom-file">
                                    <form action="{{ route('peminjaman.import') }}" method="post"
                            ...
                            <div class="show-search mb-3" style="display: none">
                                <form id="search" method="GET" action="{{ route('peminjaman_user.index') }}">
                                    <div class="form-row">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <a class="btn btn-secondary" href="{{ route('peminjaman_user.index') }}">Reset</a>
                                    </div>
                                </form>
                            </div>
                                ...
                                <table class="table table-bordered table-md">
                                    <tbody>
                                        ...
                                        @foreach ($peminjamans as $key => $peminjaman)
                                            <tr>
                                                <td>{{ ($peminjamans->currentPage() - 1) * $peminjamans->perPage() + $key + 1 }}
                                                </td>
                                                ...
                                                <td>{{ date('d-m-Y', strtotime($peminjaman->tanggal_batas_kembali)) }}
                                                </td>
                                                {{-- <td class="text-right">
